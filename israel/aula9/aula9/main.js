...
const check = document.getElementById("ativo");
const titulo = document.getElementById("titulo");
const inputTermos = document.getElementById("num_termos");


if (ativo == null) {
    btnConfirm.value = "Confirma";
    titulo.innerText = "Quantos termos você quer calcular?";
    inputTermos.classList.remove("remove");
}
else {
    btnConfirm.value = "Calcular média";
    titulo.innerText = "Informe o valor dos termos";
    inputTermos.classList.add("remove");
}